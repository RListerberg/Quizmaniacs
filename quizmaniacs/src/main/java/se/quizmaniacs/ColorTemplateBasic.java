 ...
 * ColorTemplateBasic.VORDIPLOM_COLORS) and convenience methods for loading colors
 * from resources.
 *
 * @author Philipp Jahoda
 */
public class ColorTemplateBasic {
    ...
    public static final int[] COLORFUL_COLORS = {
            ...
            Color.rgb(106, 150, 31), Color.rgb(179, 100, 53), Color.rgb(215, 100, 40)
    };
    public static final int[] VORDIPLOM_COLORS = {
            Color.rgb(192, 255, 140), Color.rgb(255, 247, 140), Color.rgb(255, 208, 140),
            Color.rgb(140, 234, 255), Color.rgb(255, 140, 157), Color.rgb(230, 160, 180)
    };
